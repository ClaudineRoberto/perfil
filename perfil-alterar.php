                    ...
                    <form action="" class="">
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control mb-3" placeholder="Profissão">

      
                                <input type="text" class="form-control mb-3" placeholder="Descrição">
                                ...
                                <input type="text" class="form-control mb-3" placeholder="Linkedin">

                               
                                <input type="text" class="form-control mb-3" placeholder="Youtube">

                      
                                <input type="password" class="form-control mb-3" placeholder="Senha">
                                
                              
                                <input type="text" class="form-control mb-3" placeholder="Foto">
                               
                        
                                <input type="text" class="form-control mb-3" placeholder="Fundo">
